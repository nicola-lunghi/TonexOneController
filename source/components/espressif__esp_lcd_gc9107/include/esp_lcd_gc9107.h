...
#define GC9107_PANEL_IO_SPI_CONFIG(cs, dc, callback, callback_ctx)                                                     \
    {                                                                                                                  \
        .cs_gpio_num = cs, .dc_gpio_num = dc, .spi_mode = 0, .pclk_hz = 80 * 1000 * 1000, .trans_queue_depth = 10,     \
        .on_color_trans_done = callback, .user_ctx = callback_ctx, .lcd_cmd_bits = 8, .lcd_param_bits = 8,             \
        .flags = { }                                                                                                   \
    }
