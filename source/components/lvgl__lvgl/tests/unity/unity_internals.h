...
void UnityAssertEqualIntArray(UNITY_INTERNAL_PTR expected, UNITY_INTERNAL_PTR actual, const UNITY_UINT32 num_elements,
    const char* msg, const UNITY_LINE_TYPE lineNumber, const UNITY_DISPLAY_STYLE_T style, const UNITY_FLAGS_T flags);
...
#define UNITY_TEST_ASSERT_BITS(mask, expected, actual, line, message)                                                  \
    UnityAssertBits(                                                                                                   \
        (UNITY_INT) (mask), (UNITY_INT) (expected), (UNITY_INT) (actual), (message), (UNITY_LINE_TYPE) (line))
...
#define UNITY_TEST_ASSERT_GREATER_THAN_INT(threshold, actual, line, message)                                           \
    UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT) (threshold), (UNITY_INT) (actual), UNITY_GREATER_THAN,           \
...
#define UNITY_TEST_ASSERT_SMALLER_THAN_INT(threshold, actual, line, message)                                           \
    UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT) (threshold), (UNITY_INT) (actual), UNITY_SMALLER_THAN,           \
        (message), (UNITY_LINE_TYPE) (line), UNITY_DISPLAY_STYLE_INT)
...
#define UNITY_TEST_ASSERT_INT8_WITHIN(delta, expected, actual, line, message)                                          \
    UnityAssertNumbersWithin((UNITY_UINT8) (delta), (UNITY_INT) (UNITY_INT8) (expected),                               \
        (UNITY_INT) (UNITY_INT8) (actual), (message), (UNITY_LINE_TYPE) (line), UNITY_DISPLAY_STYLE_INT8)
#define UNITY_TEST_ASSERT_INT16_WITHIN(delta, expected, actual, line, message)                                         \
    UnityAssertNumbersWithin((UNITY_UINT16) (delta), (UNITY_INT) (UNITY_INT16) (expected),                             \
        (UNITY_INT) (UNITY_INT16) (actual), (message), (UNITY_LINE_TYPE) (line), UNITY_DISPLAY_STYLE_INT16)
#define UNITY_TEST_ASSERT_INT32_WITHIN(delta, expected, actual, line, message)                                         \
    UnityAssertNumbersWithin((UNITY_UINT32) (delta), (UNITY_INT) (UNITY_INT32) (expected),                             \
        (UNITY_INT) (UNITY_INT32) (actual), (message), (UNITY_LINE_TYPE) (line), UNITY_DISPLAY_STYLE_INT32)
...
#define UNITY_TEST_ASSERT_CHAR_WITHIN(delta, expected, actual, line, message)                                          \
    UnityAssertNumbersWithin((UNITY_UINT8) (delta), (UNITY_INT) (UNITY_INT8) (expected),                               \
        (UNITY_INT) (UNITY_INT8) (actual), (message), (UNITY_LINE_TYPE) (line), UNITY_DISPLAY_STYLE_CHAR)
...
#define UNITY_TEST_ASSERT_EQUAL_UINT64(expected, actual, line, message)                                                \
    UnityAssertEqualNumber(                                                                                            \
        (UNITY_INT) (expected), (UNITY_INT) (actual), (message), (UNITY_LINE_TYPE) (line), UNITY_DISPLAY_STYLE_UINT64)
