...
#error "lv_analogclock: Complex drawing is required. Enable it in lv_conf.h (LV_DRAW_COMPLEX 1)"
     ...
     */
    void lv_analogclock_set_major_ticks(
        lv_obj_t* obj, uint16_t width, uint16_t len, lv_color_t color, int16_t label_gap);
     ...
     */
    lv_analogclock_indicator_t* lv_analogclock_add_needle_line(
        lv_obj_t* obj, lv_analogclock_scale_t* scale, uint16_t width, lv_color_t color, int16_t r_mod);
    void lv_analogclock_set_hour_needle_line(lv_obj_t* obj, uint16_t width, lv_color_t color, int16_t r_mod);
    void lv_analogclock_set_min_needle_line(lv_obj_t* obj, uint16_t width, lv_color_t color, int16_t r_mod);
    void lv_analogclock_set_sec_needle_line(lv_obj_t* obj, uint16_t width, lv_color_t color, int16_t r_mod);
     ...
     */
    lv_analogclock_indicator_t* lv_analogclock_add_needle_img(
        lv_obj_t* obj, lv_analogclock_scale_t* scale, const void* src, lv_coord_t pivot_x, lv_coord_t pivot_y);
    void lv_analogclock_set_hour_needle_img(lv_obj_t* obj, const void* src, lv_coord_t pivot_x, lv_coord_t pivot_y);
    void lv_analogclock_set_min_needle_img(lv_obj_t* obj, const void* src, lv_coord_t pivot_x, lv_coord_t pivot_y);
    void lv_analogclock_set_sec_needle_img(lv_obj_t* obj, const void* src, lv_coord_t pivot_x, lv_coord_t pivot_y);
     ...
     * @return              the new indicator
     */
    lv_analogclock_indicator_t* lv_analogclock_add_arc(lv_obj_t* obj, uint16_t width, lv_color_t color, int16_t r_mod);
     ...
     * @return              the new indicator
     */
    lv_analogclock_indicator_t* lv_analogclock_add_scale_lines(
        lv_obj_t* obj, lv_color_t color_start, lv_color_t color_end, bool local, int16_t width_mod);
