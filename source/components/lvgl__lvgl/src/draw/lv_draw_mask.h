...
#define _LV_MASK_MAX_NUM 1
     ...
     * - `LV_DRAW_MASK_RES_CHANGED`: `mask_buf` has changed, it shows the desired opacity of each pixel in the given
     * line
     */
    lv_draw_mask_res_t /* LV_ATTRIBUTE_FAST_MEM */ lv_draw_mask_apply(
     ...
     */
    void lv_draw_mask_radius_init(
        lv_draw_mask_radius_param_t* param, const lv_area_t* rect, lv_coord_t radius, bool inv);
