...
#define LV_COLOR_MAKE(r8, g8, b8) LV_CONCAT(LV_COLOR_MAKE, LV_COLOR_DEPTH)(r8, g8, b8)
     ...
     */
    static inline lv_color_t LV_ATTRIBUTE_FAST_MEM lv_color_mix_premult(
    ...
    static inline void LV_ATTRIBUTE_FAST_MEM lv_color_mix_with_alpha(lv_color_t bg_color, lv_opa_t bg_opa,
        lv_color_t fg_color, lv_opa_t fg_opa, lv_color_t* res_color, lv_opa_t* res_opa)
    {
    ...
    static inline lv_color_t lv_color_hex3(uint32_t c)
    {
        return lv_color_make((uint8_t) (((c >> 4) & 0xF0) | ((c >> 8) & 0xF)),
            (uint8_t) ((c & 0xF0) | ((c & 0xF0) >> 4)), (uint8_t) ((c & 0xF) | ((c & 0xF) << 4)));
    }
