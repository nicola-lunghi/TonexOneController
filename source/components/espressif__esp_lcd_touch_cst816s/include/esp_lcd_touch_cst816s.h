...
extern "C"
{
    ...
    esp_err_t esp_lcd_touch_new_i2c_cst816s(
        const esp_lcd_panel_io_handle_t io, const esp_lcd_touch_config_t* config, esp_lcd_touch_handle_t* tp);
...
#define ESP_LCD_TOUCH_IO_I2C_CST816S_CONFIG()                                                                          \
    {                                                                                                                  \
        .dev_addr = ESP_LCD_TOUCH_IO_I2C_CST816S_ADDRESS, .on_color_trans_done = 0, .user_ctx = 0,                     \
        .control_phase_bytes = 1, .dc_bit_offset = 0, .lcd_cmd_bits = 8, .lcd_param_bits = 0, .flags = {               \
            .dc_low_on_data        = 0,                                                                                \
