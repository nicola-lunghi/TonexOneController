...
* NOTES:       
*****************************************************************************/
static float control_scale_midi_to_float(uint16_t param_index, uint8_t midi_value)
{
    float min;
    float max;
...
* NOTES:       
*****************************************************************************/
static float control_boolean_midi_to_float(uint8_t midi_value)
{
    if (midi_value == 127)
    {
        return 1.0f;
...
esp_err_t control_adjust_param_via_midi(uint8_t midi_channel, uint8_t midi_value)
{
    ...
    switch (midi_channel)
    {
        ...
        case 1:
        {
            ...
            value = control_boolean_midi_to_float(midi_value);
        } break;
        ...
        case 5:
        {
            ...
            value = control_scale_midi_to_float(param, midi_value);
        } break;
