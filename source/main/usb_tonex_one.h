...
enum TonexParameters
{
    ...
    TONEX_PARAM_PHASER_SYNC,
    TONEX_PARAM_PHASER_TS,
    TONEX_PARAM_PHASER_RATE,
    TONEX_PARAM_PHASER_DEPTH,
    TONEX_PARAM_PHASER_LEVEL,
    TONEX_PARAM_FLANGER_SYNC,
    TONEX_PARAM_FLANGER_TS,
    TONEX_PARAM_FLANGER_RATE,
    TONEX_PARAM_FLANGER_DEPTH,
    TONEX_PARAM_FLANGER_FEEDEBACK,
    TONEX_PARAM_FLANGER_LEVEL,
    TONEX_PARAM_ROTARY_SYNC,
    TONEX_PARAM_ROTARY_TS,
    TONEX_PARAM_ROTARY_SPEED,
    TONEX_PARAM_ROTARY_RADIUS,
    TONEX_PARAM_ROTARY_SPREAD,
    TONEX_PARAM_ROTARY_LEVEL,
