 ...
 *****************************************************************************/
static void __attribute__((unused)) led_strip_hsv2rgb(
 ...
 * NOTES:
 *****************************************************************************/
static size_t __attribute__((unused)) rmt_encode_led_strip(rmt_encoder_t* encoder, rmt_channel_handle_t channel,
 ...
 * NOTES:
 *****************************************************************************/
esp_err_t __attribute__((unused)) rmt_new_led_strip_encoder(
...
void leds_handle(void)
{
    ...
    case LED_STATE_BOOT_FLASH_ON:
    {
        ...
        ESP_ERROR_CHECK(rmt_transmit(LedControl.led_chan, LedControl.led_encoder, LedControl.led_strip_pixels,
            sizeof(LedControl.led_strip_pixels), &LedControl.tx_config));
